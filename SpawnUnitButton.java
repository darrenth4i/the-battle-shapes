...
public class SpawnUnitButton extends UI
{
    ...
    public SpawnUnitButton(String u, int uIndex, int stage, int cost, int cooldown) {
        ...
        unitArray = new Unit[]
        {
            new SFodder(unitStage), new STank(unitStage), new SRanger(unitStage), new SHealer(unitStage), new SWarrior(unitStage),
            new CFodder(unitStage), new CTank(unitStage), new CRanger(unitStage), new CHealer(unitStage), new CWarrior(unitStage)
        };
